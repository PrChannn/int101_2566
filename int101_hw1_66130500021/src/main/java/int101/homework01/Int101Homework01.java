...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("Work03_calculateBMI");
       System.out.println("Your BMI is : " + MyUtil.calculateBMI(45, 1.69));
       
       System.out.println("Work03_average");
       System.out.println("The average is : " + MyUtil.average(3, 6, 9));
       
    }
    static void work04UseOfObjectClass() {
        System.out.println("Work04_PersonId");
        ...
        System.out.println("Work04_BankAccount");
        BankAccount b1 = new BankAccount(001, p1);
        BankAccount b2 = new BankAccount(002, p2);
        
        System.out.println("b1's deposit is : " + b1.deposit(3500.50));  
        System.out.println("b2's deposit is : " + b2.deposit(2360.35));
        
        System.out.println("Withdraw");
        b1.withdraw(350);
        b2.withdraw(650.50);
        System.out.println("b1 balance is : " + b1.getBalance());
        System.out.println("b2 balance is : " + b2.getBalance()); 
